      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-ems-400">EMS Narrative Generator</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered documentation tool for emergency medical services professionals. Save time and improve accuracy with our advanced narrative generation system.
            </p>
            <p className="text-gray-500 text-sm">
              © {currentYear} EMS Narrative Generator. All rights reserved.
            </p>
          </div>
